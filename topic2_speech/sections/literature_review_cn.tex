...
keyword spotting 里常见的学习型路线包括小型 DNN/CNN\cite{chen2014kws,sainath2015}、Speech Commands 式有限词表评测\cite{warden2018}、Transformer 与自监督语音表征\cite{berg2021,baevski2020,hsu2021hubert,chen2022wavlm,gao2023}，以及流式开放词表检测\cite{kim2025}。本文仍先用课堂频谱模板定义主线，再用 \texttt{course\_filterbank\_corr} 做 AI 重做对照，并把 MLP/CNN 作为神经网络对照。
